...
<body class="bg-light">
    <div class="container mt-5">
        <h1 class="text-center mb-4">Liste des objets</h1>        <form method="get" action="../traitement/recherche.php" class="mb-4">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-check">
                        ...
                        <input type="checkbox" name="disponibilite" id="disponibilite" value="1" class="form-check-input"
                            <?php if (isset($_GET['disponibilite']) && $_GET['disponibilite'] == '1'); 
                            ?>
                        >
                    </div>
